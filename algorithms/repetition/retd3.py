"""
Repetition TD3 (ReTD3).

This algorithm follows TD3 but trains from the short-term episode memory used
by repetition-based RL methods.
...
class ReTD3:
    """TD3 variant used with repetition-based memory."""
    ...
    def train_policy(self, memory, batch_size: int) -> None:
        """Update actor and critic using short-term repetition memory."""
    ...
    def save_models(self, filename: str, filepath: str = "models") -> None:
        ...
        logging.info("ReTD3 models have been saved.")
    ...
    def load_models(self, filepath: str, filename: str) -> None:
        ...
        logging.info("ReTD3 models have been loaded.")
